    ...
    return (
      <div className="w-full">
        ...
        <select
          ...
          ref={ref}
          className={cn(
            'w-full rounded-xl border border-white/10 bg-surface px-4 py-2.5 min-h-[44px] text-base sm:text-sm text-text transition-colors focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent/30 disabled:cursor-not-allowed disabled:opacity-40 appearance-none bg-no-repeat bg-[length:16px] bg-[right_14px_center]',
