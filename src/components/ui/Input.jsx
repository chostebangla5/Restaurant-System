      ...
      <div className="w-full">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            type={type}
            className={cn(
              'w-full rounded-xl border border-white/10 bg-surface px-4 py-2.5 text-sm text-text transition-colors placeholder:text-muted/50 focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent/30 disabled:cursor-not-allowed disabled:opacity-40',
              leftIcon && 'pl-10',
              rightIcon && 'pr-10',
